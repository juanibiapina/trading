...
|--------|-------|--------|------------|----------------|----------|-------|
| ONMD | $0.94 | 108 | 2026-07-29 00:00 CET | B | d40549db | OneMedNet Corp, regulatory-grade real-world healthcare data on Palantir Foundry. **Catalyst: $11.5M+ agreement to supply iRWD data for foundational AI model training** (GlobeNewswire, 07-28, ~16:55 ET — explains the 16:59 ET ignition). Deal is ~4x FY2025 bookings of $2.79M, so B borders A on magnitude; graded **B** (contract win) → hold up to 2 days, stop -15% from entry. Entry at the AH high on the night's cleanest accumulation: 1.05M sh / 3,182 trades in the 17:10 bar, second leg to a new high $0.95 at 17:39 ET. Day% +17.0%, entry extension +49% vs the $0.71 close. Fill $0.94 vs live SIP $0.91-0.95 — no stale-book artifact this time. **07-29 10:30 CET:** PM $0.86 (-8.5%), SIP vwap $0.85, liquid. Peak +17% (OVN $1.10), below +30% trail. Above -15% stop ($0.80). Day 1 of 2 → HOLD. |

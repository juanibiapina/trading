...
|--------|-------|--------|------------|----------------|----------|-------|
| INLF | $4.12 | 22 | 2026-07-27 23:00 CET | None | 76dc5a7d | **No catalyst** (structured search found nothing same-day; latest news Oct-Nov 2025 + Jun 2026). Low-float runner: float 1.0M, INLIF Limited (industrial automation/robotics, China small-cap). AH BUILD/hold: 3 AH scans >10% (22:30 +23.5% → 22:45 +35.4% → 23:00 +31.7%). Peaked $4.65 @16:25 ET, holding $4.20-4.35 (within ~6% of AH high). Day +2.8% (not dead-cat), Total +35% (under 150% ceiling). Real accumulating SIP volume through 16:45 ET (142K-497K sh/bar, VWAP $3.76→$4.42). Spike-bar ignition 16:09 ET. Grade None → **exit at first premarket opportunity.** |
| BZFD | $1.30 | 2026-07-28 00:30 CET | 76 | abb707e6 | **Grade C catalyst:** BuzzFeed announced 35% workforce layoffs today (cost-cut/restructuring after Byron Allen $120M majority-stake takeover; market read bullish). Q2 earnings Aug 4, not today. Float 11.9M. AH BUILD/hold: 2 AH scans >10% (00:00 +13.3% → 00:30 +12.4%). Built $1.13→$1.37 peak @17:40 ET, holding $1.26-1.30 (within ~8% of AH high). Day +1.8% (not dead-cat), Total +14.4% (low extension). Real accumulating SIP volume last hour (21:20Z-22:00Z bars 19K-81K sh, VWAP $1.28-1.31). Spike-bar ignition 17:41 ET (thin: 57 trades/18k sh). Grade C → **exit in premarket.** |
| DOMO | $3.92 | 25 | 2026-07-22 23:32 CET | A | 32f667b6 | **Grade A catalyst:** Domo announced agreement to sell substantially all assets + certain liabilities to Progress Software for **$400M** (Business Wire ~16:15 ET). AH BUILD-and-hold: 2 AH scans >10% (23:00 +31.7% → 23:30 +24.8%), peaked $3.95 (+14.8%) at 17:00 ET, holding $3.88-3.92. Day -8.4% (not dead-cat), Total +14.2% (low extension). Real accumulating SIP volume (16:45 ET bar 439k sh/1857 trades; sustained 52k-315k sh/bar after). Two-sided book bid $3.82/ask $3.91 x100. Float 36.9M. Grade A → hold up to 5 days, trail stop -20% from peak. **07-23 10:30 CET: HOLD** — day 1, -2.5%, catalyst intact, peak $4.20 PM (+7% from entry, below +50% trail threshold), within -25% hard stop ($2.94). **07-23 14:30 CET: HOLD** — day 1, now $4.19 (+6.9%), bid $4.14. New SIP peak $4.50 at 11:55Z (+14.8% from entry) on heavy real volume (1.98M sh/bar), faded to $4.14. Peak below +50% trail threshold → no trail. Well above -25% hard stop. Catalyst intact. **07-24 10:30 CET: HOLD** — day 2/5, now $3.93 (+0.3%). Peak stays $4.50 (+14.8%, below +50% trail). PM $3.91-3.94 liquid. Above -25% hard stop. Catalyst intact. **07-24 14:30 CET: HOLD** — day 2/5, now $4.02 (+2.6%). Peak stays $4.50 (+14.8%, below +50% trail). PM holding $3.91-4.00. Above -25% hard stop ($2.94). Catalyst intact. **07-24 EXIT-FLAGGED (Juan feedback, FEEDBACK_LOG 2026-07-24):** Juan questioned the hold ("really bad... I don't get it"). DOMO is a cash-buyout/merger-arb name (Progress $400M all-cash), which pins the price and kills the AH->PM momentum the strategy needs — mis-graded as a Grade-A momentum hold. **Sell at the next premarket position-eval pulse** (not now: AH book is $3.17 x $4.23, ~30% spread). Now $3.71 (-5.4%). |

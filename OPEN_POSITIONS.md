...
| VTAK | $0.72 | 125 | 2026-07-14 00:00 CET | None (no fresh same-day catalyst; squeeze setup: short interest +606% June, 2.0M float, Flyte/LifeVac theme July 6-8) | 3dbb0e53 | Catheter Precision. Float 2.0M, VRatio 0.3x (artifact of 24.6M avg vol; SIP shows real 466K-1.4M sh/bar). AH >10% across 2 AH scans (23:30 +31.8%, 00:00 +41.1%). Total% +21.5%. SIP-verified BUILD-and-hold: new high $0.84 at 17:30 ET, holding $0.72-0.81. Day% -13.9% (above -15%, AH reclaims above close). **Grade None → exit at first premarket opportunity.** |
| GCTK | $0.87 | 101 | 2026-07-14 00:30 CET | A (completed strategic business combination with Lōkahi Therapeutics; GlobeNewswire same-day) | 1afba3d0 | Glucotrack. Float 6.2M (ideal). Total% +102.8%. SIP-verified strong BUILD: accelerating volume 1.4M→3.66M sh/bar (10K+ trades), price $0.55→$0.99 making new highs at latest bar (18:15 ET). AH >10% substance met at both 00:00 (real SIP $0.80, scanner lagged +9.6%) and 00:30 (+77.7%). Quote stale/illiquid-looking (`ask $0.00 x0 @ 16:00 ET`) but SIP proves live fillable book. **Grade A: hold up to 5 days, trail stop -20% from peak.** Concern: reverse-merger structure = dilution/control-change risk. |

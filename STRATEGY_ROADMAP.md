...
**Latest status (2026-08-04): First live third-bar outcome recorded; no 5-minute pulse change justified.** The 2026-08-03 AH session produced the first out-of-sample rows: JELD was the sole `CONFIRM-3 YES` and its next-PM high was **-2.8%** below the $1.76 confirmed close; three of four recorded `NO` rows failed outright (ABTS -9.5%, BRCC flat, CSAI -3.0%), while IPW bounced +24.1% but stayed below its ~$0.90 AH peak. This is n=5, not evidence for a gate or schedule change. `CONFIRM-3` remains log-only and cannot affect entry, grading, ranking, or schedules. Full table and caveats are in `INIT3_IGNITION_TIMING.md`. Parallel check: Init 6's continuation-gate sample rose to n=11, still one short of the n>=12 trigger for its deferred one-minute exit test; the refreshed 5-minute exits remain negative after spread.

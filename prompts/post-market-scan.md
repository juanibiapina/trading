...
- Has a clear catalyst — for every stock with AH change >10%, do a structured catalyst search:
  ...
  4. If none of the above finds a catalyst, note "no catalyst found" and check float — see "No-catalyst handling" below.

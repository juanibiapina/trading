...
**AH-peak-vs-PM-peak check:** For each mover, note whether the PM peak *exceeded* or *fell short of* the AH peak. When the AH peak was higher (AH was the better exit), flag it. We are testing the hypothesis that extreme AH runners tend to peak in after-hours and fade into PM rather than continuing. Known cases: MSW (Jun 9: AH +292% > PM +221%, first >250% data point); DSY (Aug 6→7: AH +134% > PM +98%, entered $7.10 near the AH top and PM never reclaimed entry → a real entry loss, AH peak $8.21 was the exit); AQB (Aug 6→7: AH +114% > PM +47%, faded into PM). DSY and AQB extend the pattern to a **lower ~+130% threshold**: runners topping in the ~+130%+ zone fade into PM, so the AH peak is the better exit and entering near an extreme AH top (>~+130% from close) risks a PM that never reclaims it. Tally these cases in Notes (date, ticker, AH peak %, PM peak %, whether AH was the better exit); if the ~+130%+ cluster keeps recurring, it argues for taking partial profit in late AH on extreme runners rather than holding for PM.
